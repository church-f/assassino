...
export default function AvatarIcon(props){
    const idAvatarMap = new Map([
        ...
        [1, <ElderlyIcon color={props.selected ? "primary" : "inherit"} {...props} />],
        [2, <BlindIcon color={props.selected ? "primary" : "inherit"} {...props} />],
        [3, <ChurchIcon color={props.selected ? "primary" : "inherit"} {...props} />],
    ...
    console.log('AvatarIcon props:', props);
