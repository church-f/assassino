...
export default function RegisterPage() {
    ...
    const onGoogle = async () => {
        ...
        setLoading(false);
        showToast({ severity: 'success', message: "Registrazione con Google effettuata con successo" });
        setTimeout(() => {
            navigate("/home");
        }, 500);
    };
    ...
    const onRegister = (e) => {
        ...
        signupAndCreateSession({ email, password: pass, displayName: username }).then(() => {
            showToast({ severity: 'success', message: "Registrazione effettuata con successo" });
            setLoading(false);
            setTimeout(() => {
                navigate("/home");
            }, 500);
