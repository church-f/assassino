            ...
            >
                <Container maxWidth="sm" sx={{ px: 2 }}>
                    ...
                    <Stack spacing={1.2} sx={{ mb: 2 }}>
                        ...
                        <Typography sx={{ opacity: 0.75, fontSize: 13.5 }}>
                    ...
                    >
                            ...
                            {room.players.map((p) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <PersonOutlineIcon sx={{ opacity: 0.85 }} />
                                        </Box>
                                        ...
                                        <Box sx={{ minWidth: 0, flex: 1 }}>
                                            ...
                                            {
                                                isAdmin ? <Typography sx={{ opacity: 0.65, fontSize: 12 }}>
                        ...
                        {isAdmin && (
                            <Box sx={{ mt: 2 }}>
                                ...
                                <Typography sx={{ mt: 1, opacity: 0.65, fontSize: 12.5 }}>
